...
Nesta etapa, cada membro da equipe desenvolveu uma visão particular sobre o funcionamento do sistema e a jornada do usuário. O uso de Rich Pictures individuais permitiu explorar diferentes fluxos e necessidades antes da consolidação final.
  ...
  <ul>
    <li><strong>Ana Carolina:</strong><br><img src="../assets/Design_Sprint/RichPicture_Ana_Carolina.png" alt="RP Ana Carolina"></li>
    <li><strong>Guilherme Flyan:</strong><br><img src="../assets/Design_Sprint/RichPicture_GuilhermeFlyan.png" alt="RP Guilherme Flyan"></li>
    <li><strong>Davi Negreiros:</strong><br><img src="../assets/Design_Sprint/RichPicture-DaviNegreiros.png" alt="RP Davi Negreiros"></li>
    <li><strong>Pedro Henrique:</strong><br><img src="../assets/Design_Sprint/Rich_Picture_Pedro.png" alt="RP Pedro Henrique"></li>
    <li><strong>Raíssa Oliveira:</strong><br><img src="../assets/Design_Sprint/RichPicture_RaissaOliveira.jpg" alt="RP Raíssa Oliveira"></li>
    <li><strong>Marjorie Mitzi:</strong><br><img src="../assets/Design_Sprint/RichPicture_Marjorie_Mitzi.jpg" alt="RP Marjorie Mitzi"></li>
    <li><strong>Gabriel Pinto:</strong><br><img src="../assets/Design_Sprint/Rich%20-%20Gabriel%20Pinto.png" alt="RP Gabriel Pinto"></li>
    <li><strong>Yasmin:</strong><br><img src="../assets/Design_Sprint/richpictureYasmin.jpg" alt="RP Yasmin"></li>
    <li><strong>Maria Samara:</strong><br><img src="../assets/Design_Sprint/Screenshot_20260328_123145_Samsung%20Notes%20(1).jpg" alt="RP Maria Samara"></li>
    <li><strong>João Marcelo:</strong><br><img src="../assets/Design_Sprint/RichPicture_JoaoMarceloGuimaraes.png" alt="RP João Marcelo"></li>
  </ul>
